...
const SpacesSection = () => {
  ...
  return (
    <section className="relative z-20 min-h-screen overflow-hidden bg-background">
      {/* Location badge */}
      <ScrollReveal>
        <div 
      ...
      <ScrollReveal direction="scale">
        <div 
          className="relative w-full h-[70vh] overflow-hidden bg-gradient-to-b from-muted/50 to-muted"
        >
