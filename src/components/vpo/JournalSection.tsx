    ...
    <section id="journal" className="relative z-10 bg-[#FDFBF7] border-t border-stone-200">
      <div className="max-w-[1600px] mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="flex items-end justify-between mb-12 md:mb-16">
          ...
          <a
            href="#"
            className="text-sm text-stone-500 font-sans underline underline-offset-4 decoration-stone-300 hover:text-stone-900 hover:decoration-stone-900 transition-colors"
          >
            View Archive
          </a>
        </div>
            ...
            <article key={index} className="group cursor-pointer">
              ...
              <div className="relative aspect-[4/5] overflow-hidden mb-6">
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-[10px] tracking-[0.2em] uppercase text-stone-600 bg-white/90 backdrop-blur-sm px-3 py-1.5 font-sans">
                    {article.category}
                  </span>
                </div>
              </div>
              ...
              {/* Content */}
              <div>
                <span className="text-xs text-stone-400 font-sans block mb-2">
                  {article.date}
                </span>
                <h3 className="font-display text-xl md:text-2xl text-stone-900 italic mb-3 group-hover:underline decoration-1 underline-offset-4 decoration-stone-300">
                  {article.title}
                </h3>
